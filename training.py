...
init_epoch = CFG.TRAIN.RESTORE_FROM_CHECKPOINT.START_EPOCH if continue_train else 0
...
if model_arch == 'BiSeNetV2':
    ...
    model = UNetPP(inst_channels=5 if loss_type=='SpatialEmbed' else 4).to(device)
